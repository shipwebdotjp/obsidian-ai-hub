...
def test_get_unique_path(tmp_path):
    ...
    directory.mkdir()
    filename = "screen_20260528_183000.jpg"
    ...
    path = take_screenshot.get_unique_path(directory, filename)
    assert path == directory / "screen_20260528_183000_1.jpg"

    # Test multiple existing paths
    (directory / "screen_20260528_183000_1.jpg").touch()
    path = take_screenshot.get_unique_path(directory, filename)
    assert path == directory / "screen_20260528_183000_2.jpg"
