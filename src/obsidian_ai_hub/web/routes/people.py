...
@router.get("/people/vault-report", response_model=schemas.VaultReportResponse)
...
# Dynamic route /people/{person_id} must be registered after static paths on the same level
# (e.g. /people/candidates, /people/duplicates, /people/vault-report) to avoid parameter collision.
...
@router.post("/people/candidates/{candidate_id}/summaries/{summary_id}/assign", response_model=schemas.PersonActionResponse)
...
@router.post("/people/candidates/{candidate_id}/resolve", response_model=schemas.PersonActionResponse)
