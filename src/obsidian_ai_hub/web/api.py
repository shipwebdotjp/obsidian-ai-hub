...
def get_project_candidate(candidate_id: int, _=Depends(_require_loopback_or_token)):
...
def get_project(project_id: int, _=Depends(_require_loopback_or_token)):
...
def get_command_run_detail(run_id: str, _=Depends(_require_loopback_or_token)):
...
def get_llm_call_detail(call_id: str, _=Depends(_require_loopback_or_token)):
...
def get_hitl_run(run_id: str, _=Depends(_require_loopback_or_token)):
...
def cancel_hitl_run(run_id: str, _=Depends(_require_loopback_or_token)):
    try:
