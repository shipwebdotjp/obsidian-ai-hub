...
- **people**: 人物メモ（**最大10件**まで）。`{"name": "...", "note": "..."}` の配列。**現在生存している実在の人物で、筆者と直接的な関係がある身近な相手（家族・親族・友人・知人・同僚・直接対話・面会・連絡を取った相手など）のみ**を抽出してください。宗教上の人物、歴史上の人物、物語・創作の登場人物、読書・研究・学習・メディアで触れただけの対象者は除外してください。人物を表す呼称は、入力に出現した表記を省略・正規化・言い換えせずそのまま `name` に設定してください。
