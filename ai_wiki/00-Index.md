...
- [人物同定に関する決定記録](10-Decisions-People.md)
- [テスト層再編プラン (Phase 0 完了)](../docs/test-reduction/plan.md)
- [E2E を重大なユーザーフローに限定する (Phase 7〜9 追加検証)](10-Decisions.md#e2e-を重大なユーザーフローに限定する-phase-7〜9-追加検証)
...
- [Inbox分類にリマインダー登録カテゴリとHITL承認を追加](10-Decisions.md#inbox分類にリマインダー登録カテゴリとhitl承認を追加)（2026-08-15）
